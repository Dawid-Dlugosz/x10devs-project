...
1. Zidentyfikuj kluczowe widoki i ekrany na podstawie wymagań produktu i dostępnych akcji w cubitach.
2. Określ potencjalne przepływy użytkownika i nawigację między widokami, uwzględniając możliwości cubitów.
3. Rozważ komponenty UI i wzorce interakcji, które mogą być konieczne do efektywnej komunikacji z cubitami.
4. Pomyśl o responsywności i dostępności interfejsu.
5. Oceń wymagania bezpieczeństwa i uwierzytelniania w kontekście integracji z cubitami.
6. Rozważ wszelkie konkretne biblioteki UI lub frameworki, które mogą być korzystne dla projektu.
7. Przeanalizuj, jak struktura cubitów wpływa na projekt UI i przepływy danych w aplikacji.
...
1. Hierarchia i organizacja widoków w odniesieniu do struktury cubitów
2. Przepływy użytkownika i nawigacja wspierane przez dostępne cubity
3. Responsywność i adaptacja do różnych urządzeń
4. Dostępność i inkluzywność
5. Bezpieczeństwo i autoryzacja na poziomie UI w powiązaniu z mechanizmami cubitów
6. Spójność designu i doświadczenia użytkownika
7. Strategia zarządzania stanem aplikacji i synchronizacji z cubitami
8. Obsługa stanów błędów i wyjątków zwracanych przez cubity
9. Strategie buforowania i optymalizacji wydajności w komunikacji z cubitami
...
Pamiętaj, że Twoim celem jest dostarczenie kompleksowej listy pytań i zaleceń, które pomogą w stworzeniu solidnej architektury UI dla MVP, w pełni zintegrowanej z dostępnymi akcjami cubitów. Skoncentruj się na jasności, trafności i dokładności swoich wyników. Nie dołączaj żadnych dodatkowych komentarzy ani wyjaśnień poza określonym formatem wyjściowym.
